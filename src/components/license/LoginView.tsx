...
export function LoginView() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-indigo-50 dark:from-gray-950 dark:via-gray-900 dark:to-indigo-950 p-4">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-violet-200/30 dark:bg-violet-800/10 rounded-full blur-3xl" />
      </div>
          ...
          <div className="px-8 pb-6">
            <div className="text-center">
              <p className="text-[11px] text-gray-400 dark:text-gray-600">
                DeskCraft v1.0.0 &middot; 100% offline &middot; Seus dados nunca saem do seu computador
              </p>
            </div>
          </div>
        </div>
